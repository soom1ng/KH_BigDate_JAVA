...
class SportsCar extends Vehicle{
    ...
    SportsCar(String name) {
        isTurbo = false; // 터보모드가 켜지면 차의 최고 속도를 증가시키는 기능, 상속 받은 기능이 아님 .
        speed = 280; // Vehicle로 부터 상속받음 .
        this.name = name; // 생성자로 부터 이름을 입력받아 인스턴스 필드의 초기값으로 사용
        color = "Red";
    }
    int getSpeed() { // 게터라고 부름 .
